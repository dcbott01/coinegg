...
def send_login_request(init_data):
    ...
    headers = {
        ...
        'Origin': 'app-coop.rovex.io',
        'Pragma': 'no-cache',
        'Referer': 'app-coop.rovex.io/',
...
def print_welcome_message(start_time):
 ...
 |_|\_/_/ \_\/___/_/ \_\_|_\/_/ \_\
    ...
    """)
    print(Fore.GREEN + Style.BRIGHT + "COIN EGG BOT")
    ...
    print(Fore.RED + Style.BRIGHT + "Update Link: https://github.com/dcbott01/coinegg")
